...
<template>
      <div>
        <div class="z-50 flex items-center justify-between w-full p-4 lg:hidden">
            <Logo />
            <Icon class="z-50 cursor-pointer left-2 top-2" size="30" name="icon-park-outline:hamburger-button"
                @click="open = true"
            />
            <div v-if="open"
                class="fixed top-0 left-0 z-50 w-full h-full h-screen bg-white"
            >
